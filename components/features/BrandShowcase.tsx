                            ...
                            <div className="flex gap-2">
                                <div className="flex-1">
                                    <button
                                        ...
                                        className="w-full px-3 py-2 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-blue-500/50 transition-all duration-300 text-xs text-gray-400 hover:text-white flex items-center justify-center gap-2"
                                    >
